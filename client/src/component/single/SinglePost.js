...
const SinglePost = observer(() => {
    const PF = "https://websitejobsearch.herokuapp.com/images/";
    ...
    return (
        <Container className="d-flex justify-content-center align-items-center">
            <Card className="text-center" style={{width: '45rem', height: 540, marginTop: 88, borderRadius: 20, background: "linear-gradient(to top left, #999966 0%, #669999 100%)", border: "2px solid black", overflow: "scroll"}}>
                <div>
